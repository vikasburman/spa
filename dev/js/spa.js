	...
	var spaClass = function() {
		...
		function tagCloud(tags) {
			...
			var allTags = $('<div>').append(
				$('<span>').attr('style', 'font-size:25px;').append(
					$('<a>').attr('href', '#').on('click', function() { onSearch(null, 1); }).append("Favorites")).append(" "));
			allTags.append(		
				$('<span>').attr('style', 'font-size:20px;').append(
					$('<a>').attr('href', '#').on('click', function() { onSearch(null, 2); }).append("Uncategorized")).append(" "));
			allTags.append(		
				$('<span>').attr('style', 'font-size:18px;').append(
					$('<a>').attr('href', '#').on('click', function() { onSearch(null, 3); }).append("Expiring")).append(" "));
			allTags.append(		
				$('<span>').attr('style', 'font-size:16px;').append(
					$('<a>').attr('href', '#').on('click', function() { onSearch(null, 4); }).append("Expired")).append(" "));
			allTags.append(		
				$('<span>').attr('style', 'font-size:14px;').append(
					$('<a>').attr('href', '#').on('click', function() { onSearch(null, 5); }).append("Trashed")).append(" "));
		...
		function onSearch(searchDepth, searchType) {
			...
			if (typeof searchType === 'undefined') {
				searchType = spa.app.state.searchType; // 0-Default, 1-favorites, 2-uncategorized, 3-Expiring, 4-Expired, 5, Trashed, 6-A specific tagged items
			};
